...
pop1_avg = mean(population1)
pop1_sd = stdev(population1, pop1_avg)
pop1_lowest = least(population1)
z_pop1_lowest = z_score(pop1_lowest, pop1_avg, pop1_sd)
print(f"The z-score of the lowest value of population 1 is {z_pop1_lowest}")
pop2_avg = mean(population2)
pop2_sd = stdev(population2, pop2_avg)
pop2_lowest = least(population2)
z_pop2_lowest = z_score(pop2_lowest, pop2_avg, pop2_sd)
print(f"The z-score of the lowest value of population 2 is {z_pop2_lowest}")
pop3_avg = mean(population3)
pop3_sd = stdev(population3, pop3_avg)
pop3_lowest = least(population3)
z_pop3_lowest = z_score(pop3_lowest, pop3_avg, pop3_sd)
print(f"The z-score of the lowest value of population 3 is {z_pop3_lowest}")
pop1_highest = greatest(population1)
z_pop1_highest = z_score(pop1_highest, pop1_avg, pop1_sd)
print(f"The z-score of the greatest value of population 1 is {z_pop1_highest}")
pop3_highest = greatest(population3)
z_pop3_highest = z_score(pop3_highest, pop3_avg, pop3_sd)
print(f"The z-score of the greatest value of population 3 is {z_pop3_highest}")
pop3_avg = mean(population3)
pop3_sd = stdev(population3, pop3_avg)
pop3_avg = mean(population3)
pop3_sd = stdev(population3, pop3_avg)
test_case1 = 345
z_test1 = z_score (test_case1, pop3_avg, pop3_sd)
print(f"Z-score of {test_case1} in population3: {z_test1}")
pop2_avg = mean(population2)
pop2_sd = stdev(population2, pop2_avg)
test_case2 = 20
z_test2 = z_score(test_case2, pop2_avg, pop2_sd)
print(f"Z-score of {test_case2} in population2: {z_test2}")
